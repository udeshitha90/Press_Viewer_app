 ...
 */
public class AllSportsActivity extends ListActivity {
    private ProgressDialog pDialog;
    JSONParser jParser = new JSONParser();
    ArrayList<HashMap<String, String>> LinksList;

    private static String url_all_link = "http://pressviewersl.tk/get_all_link_Sports.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_sports);
        TextView tottxt=(TextView)findViewById(R.id.txtsport);
        ...
        if(connected==true) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent a=new Intent(AllSportsActivity.this,Youtube.class);
                    a.putExtras(basket);
                    startActivity(a);
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllSportsActivity.this);
            pDialog.setMessage("Loading  sports. Please wait...");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllSportsActivity.this, LinksList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name });
                    // updating listview
