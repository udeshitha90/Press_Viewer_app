...
public class AllMoviesActivity extends ListActivity {
    ...
    private static String url_all_link = "http://pressviewersl.tk/get_all_link_Movies.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tottxt=(TextView)findViewById(R.id.txtmovies);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent a=new Intent(AllMoviesActivity.this,Youtube.class);
                a.putExtras(basket);
                startActivity(a);
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllMoviesActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllMoviesActivity.this, LinkList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name });
                    // updating listview
