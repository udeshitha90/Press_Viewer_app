 ...
 */
public class AllBusinessActivity extends ListActivity {
    private ProgressDialog pDialog;
    JSONParser jParser = new JSONParser();
    ArrayList<HashMap<String, String>> LinkList;

    private static String url_all_link = "http://pressviewersl.tk/get_all_link_Business.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_business);
        TextView bustxt=(TextView)findViewById(R.id.txtbusiness);
        ...
        if(connected==true) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent a = new Intent(AllBusinessActivity.this, Youtube.class);
                    a.putExtras(basket);
                    startActivity(a);
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllBusinessActivity.this);
            pDialog.setMessage("Loading business. Please wait...");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllBusinessActivity.this, LinkList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name });
                    // updating listview
