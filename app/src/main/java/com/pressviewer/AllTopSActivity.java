...
/**
 * Created by CHATHUSANKA on 8/2/2015.
 */
public class AllTopSActivity extends ListActivity {
    private ProgressDialog pDialog;
    JSONParser jParser = new JSONParser();
    ArrayList<HashMap<String, String>> LinksList;

    private static String url_all_link = "http://pressviewersl.tk/get_all_products.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_tops);
        TextView tottxt=(TextView)findViewById(R.id.txttop);
        ...
        if(connected==true) {
       LinksList = new ArrayList<HashMap<String, String>>();
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast toast = Toast.makeText(context, pid, duration);
                toast.show();
                Bundle basket=new Bundle();
                basket.putString("key",pid);
                Intent a=new Intent(AllTopSActivity.this,Youtube.class);
                a.putExtras(basket);
                startActivity(a);
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllTopSActivity.this);
            pDialog.setMessage("Loading top stories. Please wait...");
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < newslink.length(); i++) {
                        ...
                        String rating=c.getString(TAG_RATE);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllTopSActivity.this, LinksList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name});
                    // updating listview
