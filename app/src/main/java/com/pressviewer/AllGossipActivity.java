 ...
 */
public class AllGossipActivity extends ListActivity {
    private ProgressDialog pDialog;
    JSONParser jParser = new JSONParser();
    ArrayList<HashMap<String, String>> LinkList;

    private static String url_all_link = "http://pressviewersl.tk/get_all_link_Gossip.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.all_gossip);
        TextView tottxt=(TextView)findViewById(R.id.txtgossip);
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent a=new Intent(AllGossipActivity.this,Youtube.class);
                a.putExtras(basket);
                startActivity(a);
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(AllGossipActivity.this);
            pDialog.setMessage("Loading gossip. Please wait...");
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            AllGossipActivity.this, LinkList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name });
                    // updating listview
