...
public class Related extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tottxt=(TextView)findViewById(R.id.txtrela);
        Typeface face=Typeface.createFromAsset(getAssets(),"KaushanScript-Regular.otf");
        tottxt.setTypeface(face);
        Bundle gotBasket=getIntent().getExtras();
        String gotlink=gotBasket.getString("key");
        Context contexta = getApplicationContext();
        int durationa = Toast.LENGTH_SHORT;
        Toast toasta = Toast.makeText(contexta, gotlink, durationa);
        toasta.show();

        url_all_link = "http://pressviewersl.tk/get_all_given_Url.php?link="+gotlink+"";
        ...
        if(connected==true) {
            ...
            lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Intent a=new Intent(Related.this,Youtube.class);
                    a.putExtras(basket);
                    startActivity(a);
                }
            });
    ...
    class LoadAlllinks extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Loading related news. Please wait...");
        ...
        protected String doInBackground(String... args) {
            ...
            JSONObject json = jParser.makeHttpRequest(url_all_link, "POST", params);
            if (json==null) {
        ...
        protected void onPostExecute(String s) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                     ...
                     * */
                    ListAdapter adapter = new SimpleAdapter( Related.this, LinksList, R.layout.list_item, new String[] { TAG_LINK,TAG_NAME},new int[] { R.id.pid, R.id.name });
                    // updating listview
